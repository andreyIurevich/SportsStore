...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Paginate()
        {
            ...
            //Act
            ProductsListViewModel rezult = (ProductsListViewModel)controller.List(null, 2).Model;

            //Assert
            Product[] prodArray = rezult.Products.ToArray();
        ...
        public void Can_Generate_Page_Links()
        {
            ...
            //Set up the delegate using a lambda expressins
